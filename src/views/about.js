...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Potable Ornate Newt</title>
        <meta property="og:title" content="About - Potable Ornate Newt" />
      </Helmet>
      <header
        data-thq="thq-navbar"
        className="about-navbar-interactive navbarContainer"
      >
        <span className="about-logo">IMMERSIVE Sound</span>
        <div data-thq="thq-navbar-nav" className="about-desktop-menu">
          <nav className="about-links">
            <Link to="/" className="about-nav12 bodySmall">
              Home
            </Link>
            <Link to="/services" className="about-nav2 bodySmall">
              About
            </Link>
            <Link to="/services" className="about-nav3 bodySmall">
              Services
            </Link>
            <Link to="/portfolio" className="about-nav4 bodySmall">
              Portfolio
            </Link>
            <Link to="/contact" className="about-nav5 bodySmall">
              Contact
            </Link>
          </nav>
        ...
        >
          <div className="about-nav">
            ...
            <nav className="about-links1">
              <span className="about-nav1 bodySmall">Home</span>
              <span className="about-nav21 bodySmall">About</span>
              <span className="about-nav31 bodySmall">Services</span>
              <span className="about-nav41 bodySmall">Portfolio</span>
              <span className="about-nav51 bodySmall">Contact</span>
            </nav>
